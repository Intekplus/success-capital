<?php
function property_budget_taxonomy() {

	$labels = array(
		'name'                       => _x( 'Budgets', 'Taxonomy General Name', 'intek-theme' ),
		'singular_name'              => _x( 'Budget', 'Taxonomy Singular Name', 'intek-theme' ),
		'menu_name'                  => __( 'Budget', 'intek-theme' ),
	...
	register_taxonomy( 'budget', array( 'property' ), $args );

}
add_action( 'init', 'property_budget_taxonomy', 0 );